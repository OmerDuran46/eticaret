...
class Datum {
  ...
  final double discountPercentRaw;
  ...
  final String gender;
  final List<MultipleDiscount> multipleDiscount;
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    discountPercentRaw: json["discount_percent_raw"].toDouble(),
    ...
    gender: json["gender"],
    multipleDiscount: List<MultipleDiscount>.from(json["multiple_discount"].map((x) => MultipleDiscount.fromJson(x))),
    ...
    cashPoint: json["cash_point"].toDouble(),
...
class MultipleDiscount {
  ...
  factory MultipleDiscount.fromJson(Map<String, dynamic> json) => MultipleDiscount(
